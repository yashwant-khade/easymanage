<!-- List of all performance reviews that this user has received. -->
<?php
require("../connection.php");
if (session_id() == "") {session_start();}
$my_wrk_id = $_SESSION['curr_user']['wrk_id'];
// ===================== SQL Queries Section =====================
$sql_query = "SELECT  perf_review.perf_id, perf_rating,  perf_review.giver_wrk_id, wrk_name, year_id
FROM perf_review 	JOIN worker ON perf_review.giver_wrk_id = wrk_id
					JOIN yearly_review ON yearly_review.perf_id = perf_review.perf_id
WHERE  perf_review.receiver_wrk_id = $my_wrk_id
...
<head >
    <meta charset="utf-8">
    <title>Performance Reviews Received</title>
    <link rel="stylesheet" href = "../stylesheets/user_list_style.css" >
    <style></style>
</head>

<body>
    <h1>Performance Reviews Received</h1>
    <?php
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php print $review_rows[$i]['giver_wrk_id']; ?></td>
