<!-- Only list tasks that this user is assigned to. -->
...
<?php
	...
	// ===================== SQL Queries Section =====================
	$sql_query = "SELECT task_id, task_name, task_due_date, task_status, task.proj_id AS proj_id, manager_wrk_id
	              FROM task JOIN  proj_management  ON task.proj_id = proj_management.proj_id
	              WHERE assigned_emp_wrk_id = $wrk_id";
	// ===================== SQL Queries Section =====================
	$task_rows = array();
	$statement    = $sql_query;
...
<head >
	<meta charset="utf-8">
	<title>Tasks Assigned to Me</title>
	...
	<table>
	    <tr>
			...
			<tr>
				...
				<td><?php print $task_rows[$i]['manager_wrk_id']; ?></td>
				<td class="button_col">
	...
	<div class="modal fade" id="myModal">
		<div class="modal-dialog">
		  <div class="modal-content"id="modalContent">
				...
				<form method="post" action="../administrative/prcs/prcs_upd_stat_asgn_tsk.php">
