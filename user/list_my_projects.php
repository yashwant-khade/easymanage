<!-- Only list projects that this user supervises. -->
...
<?php
	...
	// ===================== SQL Queries Section =====================
	$sql_query = "SELECT project.proj_id, proj_name, proj_due_date, proj_status, manager_wrk_id
				  FROM project JOIN proj_management ON project.proj_id = proj_management.proj_id
				  WHERE supervisor_dh_wrk_id = $wrk_id";
	// ===================== SQL Queries Section =====================
	$project_rows = array();
	$statement    = $sql_query;
...
<body>
	...
	<table>
		...
		<tr>
			...
			<td><?php print $project_rows[$i]['manager_wrk_id']; ?></td>
			<td class="button_col">
			...
			<td class="button_col">
				<form method="post" action="../administrative/prcs/prcs_deleting_a_project.php">
					<button class="button" name="tbd_proj" type="submit" value="<?php echo htmlspecialchars($project_rows[$i]['proj_id']); ?>">Delete</button>
				</form>
			</td>
		</tr>
		<?php } ?>
	...
	<div class="modal fade" id="myModal">
		<div class="modal-dialog">
		  <div class="modal-content"id="modalContent">
				...
				<form method="post" action="../administrative/prcs/prcs_upd_stat.php">
